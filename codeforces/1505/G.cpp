...
int main(){
    ...
    while (t--){
        ll n;
        vvll c;
        c.push_back({1, 0, 0, 1, 0});
        c.push_back({1,1,0,2,0});
        c.push_back({2,0,0,1,1});
        c.push_back({2,1,0,1,2});
        c.push_back({1,1,0,1,1});
        c.push_back({2,1,0,2,1});
        c.push_back({2,2,0,2,2});
        c.push_back({1,2,0,2,1});
        c.push_back({1,1,0,1,1});
        c.push_back({1,2,0,1,2});
        c.push_back({1,0,1,2,0});
        c.push_back({1,1,1,3,0});
        c.push_back({2,0,1,2,1});
        c.push_back({2,1,1,2,2});
        c.push_back({1,1,1,2,1});
        c.push_back({2,1,1,3,1});
        c.push_back({2,2,1,3,2});
        c.push_back({1,2,1,3,1});
        c.push_back({1,1,1,2,1});
        c.push_back({1,2,1,2,2});
        c.push_back({1,0,2,2,1});
        c.push_back({1,1,2,3,1});
        c.push_back({1,2,1,1,3});
        c.push_back({2,0,2,2,2});
        c.push_back({2,1,2,2,3});
        c.push_back({1,1,2,2,2});
        cin>>n;
        rep(i, n){
            vll a(5);
            rep(j, 5) cin >> a[j];
