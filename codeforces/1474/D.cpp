...
int main(){
    ...
    while (t--){
        ...
        bool ok = 0;
        for(ll i = max(ind2 - 1, 0LL); i <= min(ind1, n - 2); i++){ // swap i, i + 1
            ll tempb11, tempb12, tempb21, tempb22;
            if(i == 0) tempb11 = a[i + 1];
            else tempb11 = a[i + 1] - b1[i - 1];
            tempb12 = a[i] - tempb11;
            if(i == n - 2) tempb22 = a[i];
            else tempb22 = a[i] - b2[i + 2];
            tempb21 = a[i + 1] - tempb22;
            if(tempb11 >= 0 && tempb12 >= 0 && tempb21 >= 0 && tempb22 >= 0 && tempb11 + tempb21 == a[i + 1] && tempb12 + tempb22 == a[i]){
                ok = 1;
                break;
            }
        }
