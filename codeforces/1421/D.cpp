...
int main(){
    ...
    while (t--){
    	...
    	ll temp_c1, temp_c2, temp_c3, temp_c4, temp_c5, temp_c6;
    	temp_c1 = c1;
    	temp_c2 = c2;
    	temp_c3 = c3;
    	temp_c4 = c4;
    	temp_c5 = c5;
    	temp_c6 = c6;
    	c1 = min(c1, temp_c6 + temp_c2);
    	c2 = min(c2, temp_c1 + temp_c3);
    	c3 = min(c3, temp_c4 + temp_c2);
    	c4 = min(c4, temp_c5 + temp_c3);
    	c5 = min(c5, temp_c6 + temp_c4);
    	c6 = min(c6, temp_c1 + temp_c5);
    	ll ans = 0;
    	while(x != 0 || y != 0){
            if(x > 0 && y > 0){
                ll mini = min(x, y);
