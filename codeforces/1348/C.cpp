...
int main(){
    ...
    while (t--){
        ...
        string ans = "";
        if (cnt.size() == 1){
            rep(i, (cnt.begin()->second - 1) / k + 1) ans += cnt.begin()->first;
            cout << ans << "\n";
        }
            ...
            auto u = cnt.begin();
            u++;
            rep(i, (u->second - 1) / k + 1) ans += u->first;
            cout << ans << "\n";
        }
        else if (cnt.begin()->second < k){
            ll temp = 0;
            auto u = cnt.begin();
            while (temp < k) temp += u++->second;
            u--;
            cout << u->first << "\n";
        }
        else
        {
            ...
            for (auto u = cnt.begin(); u != cnt.end(); u++) rep(i, u->second) ans += u->first;
            cout << ans << "\n";
        }
    }    
    return 0;
