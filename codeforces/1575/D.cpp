...
int main(){
    ...
    else if (str.size() == 1 and (str == "0" or str == "_" or str == "X")) {
        cout << 1; return 0;
    } 
    else if (str.size() == 1) {
        cout << 0; return 0;
    ...
    ll ans;
    string last = str.substr(str.size() - 2, 2);
    bool fl = false;
    if (last == "25" or last == "50" or last == "75" or last == "00" or last == "2_" or last == "5_" or last == "7_" or last == "0_")  ans = 1;
    else if (last == "_5")  ans = 2;
    else if (last == "_0") ans = str.size() == 2 ? 1 : 2;
    else if (last == "__")  ans = str.size() == 2 ? 3 : 4; 
    else if (last == "2X" or last == "7X") {
        ans = 1;
        fl = true;
    } 
    else if (last == "X5") {
    ...
    else if (last == "5X" or last == "0X") {
        ans = str[0] == 'X' ? 0 : 1;
        fl = true;
    } 
    else if (last == "X0") {
        ans = str[0] == 'X' ? 0 : str.size() == 2 ? 1 : 2;
        fl = true;
    } 
    else if (last == "XX") {
        ans = str[0] == 'X' ? 0 : 1;
        ...
        ans = (str.size() == 2 or str[0] == 'X') ? 3 : 4;
        fl = true;
    } 
    else if (last == "_X") {
        ans = str[0] == 'X' ? 2 : str.size() == 2 ? 3 : 4;
        fl = true;
    } 
    else ans = 0;
    rep(i, str.size() - 2){
